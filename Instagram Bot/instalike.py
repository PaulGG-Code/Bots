...
class InstagramBot:
	def __init__(self,username,password):
		...
		self.bot = webdriver.Firefox(executable_path = '/Users/Paul/Documents/geckodriver')	
	...
	def likePhotos(self,amount):
		...
		bot.get('https://www.instagram.com/the_gedeon_life')
		time.sleep(2)
